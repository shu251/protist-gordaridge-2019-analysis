...
# Import original ASV tables - quality control
...
# Percent of sequence removed after decontam step
```{r}
...
### Get stats on taxonomy assignments
...
## Prepare dataframe to for barplot
...
### Average across replicates & sub to taxa
...
```{r Plotly code for 16S, warning=FALSE, message=FALSE}
library(plotly)
...
```{r Interaction 16S plot, fig.height=10, fig.width=14}
# Interactive plot
...
## Combine with original ASV table
...
## Generate table to report at taxa level
```{r, warning=FALSE, message=FALSE}
...
```{r plot SirVentsalot replicates - supplementary, fig.width=5, fig.height=10}
